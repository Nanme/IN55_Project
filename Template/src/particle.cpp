...
//        std::cout << "( " << tmpMat[12] << ", " <<  tmpMat[13] << ", " << tmpMat[14] << ", " << tmpMat[15] << ")" << std::endl;
        ...
        //camera->getRefViewMatrix()->cout("view");

//        GLMatrix View = GLMatrix();
//        View = camera->getRefViewMatrix();
//        GLMatrix TView ;//= *camera->getRefViewMatrix();
 //       View.m[0][3] = position.x;
 //       View.m[1][3] = position.y;
  //      View.m[2][3] = position.z;
   //     View.m[3][3] = 1.0f;
    //    View.cout("avant");


//        View.m[0][0] = tmpMat[0];    View.m[0][1] = tmpMat[4];    View.m[0][2] = tmpMat[8];    View.m[0][3] = position.x;
//        View.m[1][0] = tmpMat[1];    View.m[1][1] = tmpMat[5];    View.m[1][2] = tmpMat[9];    View.m[1][3] = position.y;
//        View.m[2][0] = tmpMat[2];    View.m[2][1] = tmpMat[6];    View.m[2][2] = tmpMat[10];   View.m[2][3] = position.z;
//        View.m[3][0] = tmpMat[3];   View.m[3][1] = tmpMat[7];   View.m[3][2] = tmpMat[11];     View.m[3][3] = 1.0f;
